...
insert into qna ( id, writer_id, title, contents, create_date) values (1, '1', 'a1_title', 'a1aa_contents', CURRENT_TIMESTAMP());
insert into qna ( id, writer_id, title, contents, create_date) values (2, '1', 'a2_title', 'a2aa_contents', CURRENT_TIMESTAMP());
insert into qna ( id, writer_id, title, contents, create_date) values (3, '2', 'b1_title', 'b1bb_contents', CURRENT_TIMESTAMP());
